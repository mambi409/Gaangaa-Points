      ...
      <section className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-slate-900 via-blue-950 to-indigo-950 text-white p-8 sm:p-12 md:p-16 shadow-2xl border border-slate-800">
        ...
        <div className="relative z-10 max-w-3xl space-y-6">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-blue-500/20 border border-blue-400/30 text-blue-300 text-xs font-bold tracking-wide">
            ...
            <span>Next-Generation Multi-Store Loyalty Platform</span>
          </div>
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tight leading-tight text-white">
            ...
            <span className="bg-gradient-to-r from-blue-400 via-indigo-300 to-cyan-300 bg-clip-text text-transparent">
              Endless Local Rewards.
            </span>
          </h1>

          <p className="text-sm sm:text-base text-slate-300 font-normal leading-relaxed max-w-2xl">
            OmniLoyalty connects members with local coffee shops, boutiques, grocery stores, and dining spots. Store all your reward points, dynamic QR pass, and digital discount vouchers in one seamless digital wallet.
          </p>
          ...
          <div className="flex flex-wrap items-center gap-3 pt-2">
            ...
            >
              ...
              <span>Member Sign Up / Register</span>
          ...
          <div className="pt-6 border-t border-slate-800/80 grid grid-cols-2 sm:grid-cols-4 gap-4">
            <div>
              ...
              <div className="text-xs text-slate-400 font-medium">Partner Network</div>
            </div>
            <div>
              <div className="text-xl sm:text-2xl font-black text-blue-400">10 pts / $1</div>
              <div className="text-xs text-slate-400 font-medium">Standard Earn Rate</div>
            </div>
            <div>
              <div className="text-xl sm:text-2xl font-black text-indigo-400">4 Tier Levels</div>
              <div className="text-xs text-slate-400 font-medium">Bronze to Platinum</div>
            </div>
            <div>
              <div className="text-xl sm:text-2xl font-black text-emerald-400">100% Instant</div>
              <div className="text-xs text-slate-400 font-medium">Contactless POS Scan</div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <h2 className="text-2xl font-extrabold text-slate-900 dark:text-white mt-2">
                Your Unified Digital Loyalty Pass
              </h2>
              <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-400 mt-1 leading-relaxed">
                No more carrying multiple paper punch cards or separate store apps. Keep all your store points, dynamic QR pass, and redeemed discount vouchers in one place.
              </p>
            </div>
            ...
            <ul className="space-y-2.5 pt-2 text-xs sm:text-sm text-slate-700 dark:text-slate-300">
              <li className="flex items-start gap-2.5">
                ...
                <span><strong>OmniPass QR Code:</strong> Scan at checkout to earn or redeem points instantly.</span>
              </li>
              <li className="flex items-start gap-2.5">
                <CheckCircle2 className="w-4 h-4 text-emerald-500 shrink-0 mt-0.5" />
                <span><strong>Reward Catalog:</strong> Unlock free coffee, discount codes, and store perks.</span>
              </li>
              <li className="flex items-start gap-2.5">
                <CheckCircle2 className="w-4 h-4 text-emerald-500 shrink-0 mt-0.5" />
                <span><strong>GPS Store Finder & Navigation:</strong> Get turn-by-turn directions to nearby partners.</span>
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              <span className="text-xs font-bold text-indigo-600 uppercase tracking-wider bg-indigo-50 dark:bg-indigo-950/50 px-2.5 py-1 rounded-md border border-indigo-200 dark:border-indigo-900">
                For Retail Merchants & Partners
              </span>
              <h2 className="text-2xl font-extrabold text-slate-900 dark:text-white mt-2">
                Merchant POS & Loyalty Suite
              </h2>
              <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-400 mt-1 leading-relaxed">
                Empower your staff with a web-based POS terminal to scan member digital passes, credit points on sales, validate vouchers, and broadcast push deals.
              </p>
            </div>
            ...
            <ul className="space-y-2.5 pt-2 text-xs sm:text-sm text-slate-700 dark:text-slate-300">
              <li className="flex items-start gap-2.5">
                ...
                <span><strong>POS Terminal Scanner:</strong> Camera QR scanning & manual code lookups.</span>
              </li>
              <li className="flex items-start gap-2.5">
                <CheckCircle2 className="w-4 h-4 text-indigo-500 shrink-0 mt-0.5" />
                <span><strong>Reward Catalog Manager:</strong> Add, edit, or publish custom store discounts.</span>
              </li>
              <li className="flex items-start gap-2.5">
                <CheckCircle2 className="w-4 h-4 text-indigo-500 shrink-0 mt-0.5" />
                <span><strong>Push Notification Broadcaster:</strong> Reach local members with real-time deals.</span>
              </li>
            </ul>
          </div>
