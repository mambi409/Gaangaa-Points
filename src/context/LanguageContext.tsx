...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'nav.merchant_dashboard': 'Merchant Dashboard',
    ...
    'wallet.member_only_badge': 'Members Only Access',
    'wallet.member_only_title': 'Digital Wallet is Accessible Only for Members',
    'wallet.member_only_desc': 'Your unified OmniPass, real-time points balance, dynamic QR checkout pass, tier multipliers, and digital reward vouchers are secured exclusively for registered loyalty members.',
    'wallet.btn_signin_member': 'Sign In as Member',
    'wallet.btn_register_member': 'Create Free Member Pass',
    'wallet.btn_explore_network': 'Explore Partner Stores',
    'wallet.feature_pass_title': 'Universal OmniPass QR',
    'wallet.feature_pass_desc': 'Earn points automatically at every participating merchant across the island network.',
    'wallet.feature_rewards_title': 'Digital Vouchers & Deals',
    'wallet.feature_rewards_desc': 'Store, activate, and redeem exclusive promotional discounts directly on your device.',
    'wallet.feature_tiers_title': 'Tier Progression',
    'wallet.feature_tiers_desc': 'Advance from Bronze to Silver, Gold, and Platinum for bonus multiplier perks.',
    ...
    'map.title': 'Interactive Curaçao Store Map & Route Navigation',
    'map.desc': 'View partner merchants across Curaçao and receive real-time turn-by-turn routing.',
    'map.curacao_network': 'Curaçao Merchant Network Map',
    'map.filter_category': 'Category:',
    'map.cat_all': 'All Categories',
    'map.filter_district': 'District:',
    'map.district_all': '🏝️ All Curaçao',
    'map.district_willemstad': '🏛️ Punda',
    'map.district_otrobanda': '🏰 Otrobanda',
    'map.district_pietermaai': '🎨 Pietermaai',
    'map.district_mambo': '🏖️ Mambo Beach',
    'map.district_janthiel': '⛵ Jan Thiel',
    'map.district_salina': '🛍️ Saliña & Zuikertuintje',
    'map.layer_street': 'Street',
    'map.layer_dark': 'Night',
    'map.layer_satellite': 'Satellite',
    'map.fit_all': 'Fit All',
    'map.recenter_user': 'My Location',
    'map.walking': 'Walking',
    'map.driving': 'Driving',
    'map.biking': 'Biking',
  ...
  es: {
    ...
    'nav.merchant_dashboard': 'Panel Comercio',
    ...
    'wallet.member_only_badge': 'Acceso Exclusivo para Miembros',
    'wallet.member_only_title': 'La Billetera Digital es solo accesible para Miembros',
    'wallet.member_only_desc': 'Tu OmniPass unificado, saldo de puntos en tiempo real, pase QR dinámico para pagar, multiplicadores de nivel y cupones de recompensa están reservados para miembros registrados.',
    'wallet.btn_signin_member': 'Iniciar Sesión como Miembro',
    'wallet.btn_register_member': 'Crear Pase de Miembro Gratis',
    'wallet.btn_explore_network': 'Explorar Tiendas Asociadas',
    'wallet.feature_pass_title': 'Pase QR OmniPass Universal',
    'wallet.feature_pass_desc': 'Acumula puntos al instante en cada comercio asociado de la red sin tarjetas físicas.',
    'wallet.feature_rewards_title': 'Cupones Digitales y Ofertas',
    'wallet.feature_rewards_desc': 'Guarda, activa y canjea descuentos promocionales exclusivos directamente en tu dispositivo.',
    'wallet.feature_tiers_title': 'Progresión de Niveles',
    'wallet.feature_tiers_desc': 'Avanza de Bronce a Plata, Oro y Platino para obtener mayores beneficios y multiplicadores.',
    ...
    // Interactive Map & Navigation
    'map.title': 'Mapa Interactivo de Tiendas de Curaçao y Navegación',
    'map.desc': 'Visualiza comercios asociados en toda la isla de Curaçao y recibe indicaciones paso a paso en tiempo real.',
    'map.curacao_network': 'Mapa de la Red Comercial de Curaçao',
    'map.filter_category': 'Categoría:',
    'map.cat_all': 'Todas las Categorías',
    'map.filter_district': 'Distrito:',
    'map.district_all': '🏝️ Todo Curaçao',
    'map.district_willemstad': '🏛️ Punda',
    'map.district_otrobanda': '🏰 Otrobanda',
    'map.district_pietermaai': '🎨 Pietermaai',
    'map.district_mambo': '🏖️ Mambo Beach',
    'map.district_janthiel': '⛵ Jan Thiel',
    'map.district_salina': '🛍️ Saliña y Zuikertuintje',
    'map.layer_street': 'Calle',
    'map.layer_dark': 'Noche',
    'map.layer_satellite': 'Satélite',
    'map.fit_all': 'Ver Todas',
    'map.recenter_user': 'Mi Ubicación',
